<h2 class="sectionTitle">Lab Programs <a class="createLink" href="/events/labs/add">Add New</a> </h2>
...
<script type="text/javascript">
	...
	function showEvents(hash) {
		var args = { "detail_level" : "summary", "only_labs" : "1" };
		switch(hash) {
			case "#next30":
			...
			function(data){
				...
				if(data && data.length > 0) {
					...
					$.each(data, function(index, event) {
						...
						html += "<span class=\"eventName\"><a href=\"/events/labs/edit/" + event.id + "\" title=\"Click to Edit\">" + event.name + "</a></span>";
